...
A pin without connection is a position on paper. You may be in side control, but if your body is not connected to theirs, you are sitting next to them, not controlling them. The opponent can insert frames, create angles, and escape without you knowing until it is too late.

A pin without pressure is a hug. You may be connected, but if you are not driving weight and force in a direction that limits movement, the opponent will simply push you off or work around your contact.
...
If this is ignored, the student holds positions without understanding why they work or fail. They look like they are in control but the opponent moves freely underneath them.

---

## Core Idea

Stay glued. Stay heavy. Feel everything. Restrict everything.
...
**What connection looks like.** Connection means surface area contact. Chest to chest. Hip to hip. Shoulder to shoulder. Shin to thigh. The more of your body that is in contact with theirs, the more information you receive and the less space they have to work with.

Connection points vary by position:

- _Side control_: Chest to chest, hip to hip, shoulder to jaw (crossface), arm to arm
- _Mount_: Seat to hips/stomach, knees to ribs, hands to mat or arms or head
...
- Being on top without actual body-to-body contact (hovering)
- Relying on grips for control instead of body connection
- Driving pressure in one direction without reading what the opponent is doing
...
- **Connection**: Chest to chest contact. Crossface shoulder connecting to the jaw. Hip-side arm connecting hand to far hip or threading under the near arm.
- **Pressure**: Shoulder of justice drives jaw to the far side (directional pressure = they cannot face you). Chest weight drives them flat (downward pressure = they cannot sit up). Hip drop toward their hips (lateral pressure = they cannot shrimp away).
- **Feedback Loop**: Feel the bridge beginning → shift weight forward. Feel the shrimp beginning → drop hips. Feel the frame building → tighten connection and remove the frame.

### Mount (Top)

- **Connection**: Seat to their hips/stomach. Knees squeezing ribs. Hands posted or controlling head/arms.
- **Pressure**: Hips settled heavy (downward pressure = limits bridging). Lean forward slightly over their chest (forward pressure = absorbs bridge). Knees tight (lateral pressure = prevents elbow-knee escape).
- **Feedback Loop**: Feel the bridge → shift weight forward, ride it. Feel the shrimp → drive knee into the escaping hip. Feel arm frames → control the arms and reset.

### Back Control

- **Connection**: Chest to their back, no space between. Seatbelt grip maintaining upper body connection. Hooks inside thighs or body triangle for lower body connection.
- **Pressure**: Pull them onto you (backward pressure = they cannot posture away). Hook pressure keeps their hips controlled. Seatbelt pull keeps their shoulders against your chest.
- **Feedback Loop**: Feel them turning → adjust the seatbelt and block with the top hook. Feel them sliding down → clamp and pull them back up. Feel them stripping the grip → switch grip positions while maintaining chest-to-back contact.

---

## Simple Mental Model

Be the shadow. Everywhere they go, you are already there. Everything they feel is you.
...
- Hold side control with hands clasped behind your back
- All control must come from body-to-body connection and weight distribution
- Forces you to develop true pressure instead of relying on grips
- Notice which connection points matter most when grips are removed

**Sticky Pressure Flow**

- Start in side control, transition to mount, then to north-south, then back to side control
- The rule: never break chest-to-chest (or chest-to-back) contact during the transition
- Builds the habit of maintaining connection even while changing position
