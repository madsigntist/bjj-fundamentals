...
Pinning mechanics are the principles that allow you to hold an opponent in place using structure, angle, and weight rather than muscular effort.

A pin is not about squeezing harder. It is about positioning your body so that your weight and alignment work against the opponent's ability to move.

---

## Why It Matters

Dominant position means nothing if you cannot keep it.
...
If this is ignored, the student wins positions but cannot keep them. Top control becomes a race against time instead of a platform for offense.

---

## Core Idea

Make your weight their problem, not yours.
...
**Blocking movement, not chasing it.** A common mistake is reacting to escape attempts by scrambling to stay on top. Effective pinning prevents the escape from starting. Instead of chasing the hip escape, you block the hip before it moves. Instead of countering the bridge after it happens, you remove the space needed to bridge. Anticipation beats reaction.

**Using the mat as your partner.** The mat is a wall. If you drive the opponent into it, they have nowhere to go. Shoulder pressure that pins their shoulder to the mat. Hip pressure that keeps their back flat. Crossface that pushes their head toward the mat. The mat does half the work if you use it.

These principles are not unique to one position. They appear in side control, mount, knee-on-belly, north-south, and back control. The application differs, but the mechanics stay the same.
...
- **Back control** is the most dominant pin because the opponent cannot see the attacker and the highest-percentage submission (rear naked choke) is directly available.
- **Mount** offers the widest range of submission angles and all-directional pressure.
...
- Using strength to hold position instead of structure and weight
- Leaving space between your body and the opponent
- Staying too high, allowing the opponent underneath
- Driving weight straight down without directional control
- Reacting to escapes instead of preventing them
- Ignoring the opponent turning to their side until it is too late
- Rushing to attack before the pin is established
...
- Chest-to-chest contact, shoulder driving into the opponent's jaw
- Hips low and heavy, sprawled back or angled toward their hips
- Near-side arm controlling the head (crossface) or underhooking
- Far-side arm blocking the near hip to prevent the turn

### Mount (Top)

- Knees squeezing the ribs, hips low and settled
- Hands posted or controlling the arms to prevent bridging
- Drive weight forward when they bridge, retreat when they shrimp
- Stay heavy enough that they carry your weight with every breath

### North-South (Top)

- Chest to chest, hips low
- Arms controlling the opponent's arms or hips
- Pressure through the sternum
- Angle changes cut off movement to either side

---

## Simple Mental Model

Heavy, close, flat, angled.

Be heavy. Stay close. Keep them flat. Drive at an angle.
...
- From side control, experiment with shifting your weight forward, back, and to the side
- Notice when the partner feels most compressed and least mobile
- Find the angles where your weight has the most effect
