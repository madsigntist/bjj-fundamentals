# Preventing Movement Before Attacking

---

## Definition

Preventing movement before attacking means establishing control so thorough that the opponent's escape options are shut down before you begin any offensive action. The pin comes first. The submission or transition comes second.
...
Make them stop moving. Then make your move.

---

## Detailed Explanation

This concept is about patience and sequence. There is a correct order of operations when you achieve a dominant position.

**Step 1: Arrive and stabilize.** When you pass the guard or achieve mount, the first task is to settle. Establish your grips, position your weight, and connect to the opponent. Do not immediately look for an arm or a neck. Look for stability first.

**Step 2: Shut down movement.** Once you are settled, identify what the opponent is trying to do and prevent it. Are they framing? Kill the frames. Are they trying to turn? Crossface and flatten. Are they bridging? Absorb and drive weight forward. Are they trying to create space with their hips? Block and close.
...
- Attacking immediately upon reaching a dominant position
- Interpreting the opponent's movement as an invitation to attack instead of a problem to solve first
...
Two phases. Control phase and attack phase. Never be in both at the same time.
...
**Pin-Then-Submit Drill (Timed)**

- From side control or mount, you cannot attempt any submission for the first 30 seconds
- Use those 30 seconds to establish the tightest pin possible
- After the timer, begin attacking
- Notice how much easier the submissions are when the position is fully secured
