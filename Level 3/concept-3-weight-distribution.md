...
Two people of identical weight can feel completely different on top. One feels like a blanket you can push off. The other feels like a boulder you cannot move. The difference is weight distribution.
...
If this is ignored, the student treats every top position as a grip-fighting contest instead of a pressure game. They work hard on top when they should be resting.
...
Weight distribution is about choice. At any given moment, you decide where your weight goes. That decision determines how much control you have and how much energy you spend.

**The illusion of total weight.** A common misunderstanding is that you should put all your weight on the opponent at all times. This is wrong. If all your weight is on them, you have nothing left for base. When they bridge, you have no post. When they shrimp, you have no ability to follow. Total weight commitment means total vulnerability to movement.

The goal is to put enough weight on the opponent to control them while keeping enough weight available for base and adjustment.

**Where weight matters most.** In most top positions, the highest-value targets for weight placement are:

- _The chest and shoulder line_: Weight through your chest into the opponent's chest or shoulder drives them flat and compresses their breathing. This is the primary pin zone in side control and north-south.
- _The hips_: Settling your weight into or over the opponent's hips prevents bridging and shrimping. This is the primary pin zone in mount.
- _The head and neck_: Shoulder-of-justice or crossface pressure uses your shoulder weight to turn the head. This controls direction and disrupts the spine.

Not every position uses the same target. The skill is reading the position and choosing where your weight needs to go right now.

**Shifting weight in response to movement.** The bottom player is not static. They bridge, shrimp, turn, and scramble. Each movement requires a different weight response.

- _Bridge_: Shift weight forward over the opponent's head or drive hips down to absorb the upward force.
...
A see-saw. When they push one end up, lean toward it. Never let both ends come off the ground.
...
- From mount, alternate between heavy-forward (absorbing bridge) and heavy-back (absorbing shrimp)
- Partner calls out "bridge" or "shrimp" and attempts that escape
- Practice the weight shift before they move, then after
- Build the reflex to read and respond with weight placement
