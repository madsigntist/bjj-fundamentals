...
Without base, nothing else works.
...
If this is ignored, the student will constantly fall, overcommit, and lose position even when they are technically correct.

---

## Core Idea

If you cannot be moved, you cannot be controlled.
...
- Keeping knees or feet too close together
- Not posting when balance is broken
- Overcommitting weight during movement
- Freezing instead of adjusting base
- Confusing stillness with stability
- Ignoring posture while focusing only on base
...
- When bridging, maintain connection so you do not lose balance mid-movement
- When framing, use your base to support your structure and prevent collapse

### Top Positions

- In mount, widen knees and stay balanced to avoid being bridged
- In side control, distribute weight without overcommitting forward
- When passing, stay centered to avoid sweeps

### Transitions

- While moving between positions, maintain at least one or two stable points of contact
- Use posts (hands or feet) to catch your balance during transitions
...
**Balance Disruption Drill**

- Partner attempts to push or pull lightly
- Maintain position without falling or overreacting
- Focus on adjusting base, not resisting with strength

**Post Reaction Drill**

- Partner creates sudden off-balance moments
- Student must post (hand, foot, or knee) to recover balance

---

### Progression Notes

At this level, base is about not falling and maintaining balance.
