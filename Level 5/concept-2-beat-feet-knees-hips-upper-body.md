# Beat Feet → Knees → Hips → Upper Body

---

## Definition

Guard passing follows a sequential progression: you must beat the guard player's feet first, then their knees, then their hips, and finally achieve upper body control. This is the anatomical roadmap of the pass. You cannot skip a level. Each layer must be cleared before advancing to the next.
...
A guard pass is a four-stage journey. Feet, knees, hips, upper body. Win each stage before moving to the next.

---

## Detailed Explanation

Think of the guard player's body as a series of defensive gates between you and side control. You must pass through each gate in order.

**Gate 1: Feet and ankles.** The guard player's feet are the first barrier. Feet on your hips push you away. Feet on your biceps control your arms. Feet on your shoulders push your posture back. Hooks redirect your angle. De La Riva hooks control your lead leg.

Before anything else, you must clear the feet. This means stripping them off your body, pinning them, or moving past them so they cannot re-engage. Common methods:

- Grip the pants at the ankles and push the feet to the mat
- Step back to disengage and re-approach from a better angle
- Stuff the feet inside (between the legs) so they lose their hook placement
- Use pant grips to control the direction the feet can move

**Gate 2: Knees and shins.** Once the feet are cleared, the guard player's next line of defense is their knees and shins. Knee shields block your torso from advancing. Butterfly hooks (shins inside your thighs) create elevation and sweep threats. Shin-to-shin contact maintains distance.

To clear this gate, you must flatten, pin, or redirect the knees. Common methods:

- Drive the knees to the mat on one side (knee slice / knee cut)
- Pin one knee to the mat with your hand and step over
- Backstep to change the angle and make the knee shield ineffective
- Stack the knees toward the opponent's head, compressing their guard structure

**Gate 3: Hips.** Once the knees are cleared, the hips become the last active barrier. The guard player's hips can shrimp (creating distance for re-guarding), turn (creating angles for guard recovery), or elevate (creating space for leg re-insertion).

To clear this gate, you must pin or control the hips so they cannot create the space needed for re-guarding. Common methods:

- Drive your hip into their hip, pinning it to the mat
- Underhook the far leg, controlling hip rotation
...
### Standing Pass Against Open Guard

- **Gate 1 (Feet)**: Guard player has feet on your hips. Grip pants at the knees. Push feet to the mat or step back to break foot placement. Do not advance until the feet are controlled.
- **Gate 2 (Knees)**: Feet cleared, but the guard player inserts a knee shield. Pin the top knee to the mat with your hand and begin knee-cutting across the shin. Hold the knee with grip pressure as you advance.
- **Gate 3 (Hips)**: Knees cleared, but the guard player shrimps to create space for re-guarding. Drive your hip into their near hip. Block the shrimp with your knee or hand. Do not let their hips create distance.
- **Gate 4 (Upper Body)**: Hips controlled. Slide to chest-to-chest immediately. Establish crossface. Pin shoulder to mat. Level 3 control begins.

### Knee Cut / Knee Slice Pass

- **Gate 1 (Feet)**: Strip the bottom foot from your hip. Control the pant leg to prevent re-insertion.
- **Gate 2 (Knees)**: Slice your knee across the opponent's thigh, cutting through the knee-shin barrier. Your knee pins their bottom leg as you slide through.
- **Gate 3 (Hips)**: As you slice through, your hip drops onto their hip. Underhook the far arm or grip the collar to prevent the hip escape that would re-create guard.
- **Gate 4 (Upper Body)**: Complete the slide and land in side control. Crossface, chest to chest, and Level 3 pinning mechanics take over.
...
Four doors in a hallway. You must open each one in order. If you leave a door open behind you, it swings shut and you are back where you started. Open each door, step through, and hold it open as you move to the next.
...
- Start in a guard player's open guard
- Identify which gate is currently blocking the pass: feet, knees, hips, or upper body
- Call it out loud before acting
- Builds the habit of diagnosing the correct layer before attempting to clear it
...
- Isolates each gate for focused practice
