...
## Tier 1 — Defensive Positions

These are the worst places to be. The opponent has maximum control and direct access to submissions. The student's only objective is survival and escape.
...
**Primary curriculum reference**: Level 1 (survival mechanics), Level 2 (escape sequence)

### Mount (Bottom)

The opponent sits on the torso with weight, hip control, and access to the neck and both arms. The bottom player is flattened, compressed, and defending on multiple fronts simultaneously.

**Why it is nearly the worst**: The opponent has gravity, weight, and multiple submission angles. The bottom player must bridge and frame with severely limited hip mobility.

**Primary curriculum reference**: Level 1 (frame structure), Level 2 (bridge-and-frame escape, elbow-knee escape)

### Side Control (Bottom)

The opponent pins from the side with crossface, underhook, and chest pressure. The bottom player's hips are largely immobilized and frames must be built from a compressed position.

**Why it ranks here**: While slightly less dangerous than mount (fewer direct submission angles), the bottom player has minimal mobility and the top player has excellent control. Extended time here leads to fatigue and submission vulnerability.

**Primary curriculum reference**: Level 1 (frames and posture under pressure), Level 2 (frame-to-escape sequence)

---

## Tier 2 — Recovery Positions

These positions are not safe, but they are transitional. The student has more movement options than Tier 1 and is working to return to guard (Tier 3).
...
Quarter guard, knee shield half, and other intermediate positions where the bottom player has some structural barrier but is not in a full guard position. These are often momentary positions between escape and guard recovery.

**Primary curriculum reference**: Level 2 (frame maintenance during transitions), Level 4 (retention layers)

---

## Tier 3 — Neutral / Guard Positions

These positions are neutral or slightly advantageous for the bottom player. The guard player has offensive options (sweeps and submissions) while the top player must work to advance (pass the guard). Neither player is in immediate danger.

### Closed Guard (Bottom)

The bottom player's legs are wrapped around the opponent's waist, controlling distance and hip position. The guard player has strong control and access to sweeps, submissions, and positional transitions.

**Why it ranks here**: Closed guard is the strongest bottom position. The guard player controls the distance, can break posture, and has a wide range of attacks. The top player's primary concern is posture maintenance and managing the opponent's hips.

**Primary curriculum reference**: Level 4 (distance management, off-balancing, sweep-vs-submission decisions)

### Open Guard Variations

Butterfly guard, De La Riva, spider guard, lasso guard, single-leg X, X-guard, and other positions where the bottom player uses legs and grips to control distance and create angles without closed legs.

**Why they rank here**: Open guards provide more mobility and variety than closed guard but less inherent control. The guard player must actively maintain connections and manage distance. Effective open guard play requires all of Level 4's concepts working together.

**Primary curriculum reference**: Level 4 (inside leg position, connection points, retention layers)

---

## Tier 4 — Offensive Positions

These positions favor the top player. The top player is working to advance to Tier 5 (dominant positions) and the bottom player is working to recover to Tier 3 (guard).
...
One leg is trapped but the top player has weight advantage, crossface, and underhook potential. From top half, the player can continue the pass, attack submissions, or transition to mount.

**Why it ranks here**: Top half guard provides significant control with some limitation (trapped leg). The top player is favored but cannot ignore the bottom player's sweep and guard recovery attempts.

**Primary curriculum reference**: Level 5 (passing through the half guard gate), Level 3 (maintaining pressure while completing the pass)
...
The top player places one knee on the opponent's torso while the other leg posts wide for base. Hands control the opponent's collar and far-side hip or arm.
...
**Primary curriculum reference**: Level 3 (weight distribution, pinning), Level 6 (armbar, cross-collar choke, arm triangle from mount)
...
Submissions are the endgame. They are not positions in the traditional sense but represent the final phase of a positional sequence. A submission attempt is only as good as the positional control that supports it.
...
3. **What does my opponent want?** — This determines the defensive or preventive action needed
