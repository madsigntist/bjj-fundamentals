...
**What it means**: Is there an immediate threat to my neck, my joints, or my position that requires defensive action right now?

**Why it comes first**: Nothing else matters if you are about to be choked or about to lose a limb. Safety is the precondition for everything. A student who skips this question and reaches for a sweep while a choke is locked in will be unconscious before the sweep completes.

**How to evaluate it**:

- Is my neck exposed? Can the opponent access my chin, my collar, or the space behind my neck?
- Are any of my limbs isolated? Is an arm extended away from my body? Is a leg trapped without structural support?
- Is my position deteriorating? Am I being flattened, tilted, or turned in a way that will lead to a worse position within the next few seconds?

**If the answer is "No, I am not safe"**:

- Stop all offensive activity immediately
- Address the specific threat: tuck the chin, retract the arm, re-establish frames, recover alignment
- Do not proceed to Question 2 until the answer changes to "Yes"

**If the answer is "Yes, I am safe"**:
...
- Maintain it while proceeding to Question 3
- Do not give it up by reaching for grips or angles that surrender the inside space

**Curriculum connection**: Level 1 (inside position awareness), Level 3 (maintaining inside position from top), Level 4 (inside leg position as the foundation of guard play), Level 5 (winning inside position to begin the pass)
...
- **Head**: Do I have crossface, collar tie, chin strap, or head position that dictates where their spine goes? Or does the opponent have their head free?
- **Hips**: Am I blocking, pinning, or surrounding their hips with weight, wedges, or hooks? Or are their hips free to shrimp, bridge, or elevate?
- **Both**: Controlling one is useful. Controlling both is dominant. If the opponent controls either of mine, I am in trouble.

**If the opponent controls my head or hips**:

- Fight for head position first (the head controls the spine; the spine controls the hips)
- Use frames to create space and deny the opponent's head control
- Free the hips through movement (shrimp, bridge) once the head is free
...
- Can I move my hips (shrimp, bridge, hip switch, hip heist)?
- Can I change levels (stand, kneel, sprawl)?
- Can I change angle (rotate, circle, reposition)?
- Or am I pinned, flattened, or entangled in a way that prevents all of the above?
...
- Locate your current position on the positional hierarchy (see The Positional Hierarchy chapter)
- Identify the next tier up
- Assess: is the next position achievable right now, or does something else need to happen first?

**The rule**: advance one tier at a time.

- From back control bottom → aim for turtle or side control bottom (escape to Tier 2)
- From side control bottom → aim for half guard or guard (recover to Tier 3)
- From guard → aim for passing position or sweep to top (advance to Tier 4-5)
- From side control top → aim for mount or back (advance within Tier 5)
- From mount or back → aim for submission phase (advance to Tier 6)
...
**Opponent threats (defensive scan)**:

- What submissions can they attempt from here? (neck attacks, arm attacks, leg attacks)
- What sweeps or reversals are available to them?
- What transitions might they use to improve their position?
- Which of these threats is most immediate?

**My threats (offensive scan)**:
